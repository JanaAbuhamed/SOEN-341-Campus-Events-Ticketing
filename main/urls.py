...
urlpatterns = [
    ...
    path(
        "events/<int:event_id>/save/", api_views.ToggleSaveEvent, name="ToggleSaveEvent"
    ),
    # Saved events list
    ...
    path(
        ...
        views.update_organizer_profile,
        name="update_organizer_profile",
    ),
    ...
    path(
        "events/<int:event_id>/unclaim/", api_views.unclaim_event, name="unclaim_event"
    ),
    ...
    path(
        "api/events/<int:event_id>/stats/",
        qr_views.event_stats_api,
        name="event_stats_api",
    ),
    # Analytics endpoints
    path(
        "analytics/participation-trend/",
        participation_trend,
        name="participation_trend",
    ),
    path(
        "analytics/claim-trend/", claim_trend_by_payment, name="claim_trend_by_payment"
    ),
]
