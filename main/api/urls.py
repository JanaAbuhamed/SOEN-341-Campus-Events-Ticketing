...
urlpatterns = [
    ...
    path(
        ...
        views.admin_update_event_status,
        name="admin_update_event_status",
    ),
    path(
        "admin/events/<int:event_id>/edit/",
        views.admin_edit_event,
        name="admin_edit_event",
    ),
    # NEW: inline + bulk
    path(
        "admin/users/<int:user_id>/status/json/",
        views.admin_user_set_status_json,
        name="admin_user_set_status_json",
    ),
